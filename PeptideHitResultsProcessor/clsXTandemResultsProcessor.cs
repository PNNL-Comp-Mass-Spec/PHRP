...
#End Region
    ...
    Private Function ConvertEValueToBase10Log(strExpectationValue As String) As String
    ...
    Private Function ParseXTandemInputParameterModInfo(eModificationType As clsModificationDefinition.eModificationTypeConstants, intSortOrder As Integer, blnParsingMotifDef As Boolean, strParamValue As String, ByRef intModInfoCount As Integer, ByRef udtModInfo() As udtSearchOptionModificationInfoType) As Boolean
    ...
    Private Function ParseXTandemInputParameterProteinTerminusMod(intSortOrder As Integer, blnNTerminus As Boolean, strParamValue As String, ByRef intModInfoCount As Integer, ByRef udtModInfo() As udtSearchOptionModificationInfoType) As Boolean
    ...
    Protected Function ParseXTandemResultsFile(strInputFilePath As String, strOutputFilePath As String, Optional blnResetMassCorrectionTagsAndModificationDefinitions As Boolean = True) As Boolean
    ...
    Private Function ParseXTandemResultsFileInputParameters(strInputFilePath As String) As Boolean
    ...
    Private Sub SaveXTandemResultsFileEntry(objSearchResult As clsSearchResultsXTandem, ByRef swPeptideResultsFile As StreamWriter)
    ...
    Protected Overrides Function TruncateProteinName(strProteinNameAndDescription As String) As String
