...
#Region "Classwide Variables"
    ...
    Protected mModificationCount As Integer
    Protected mModifications() As clsModificationDefinition
...
#End Region
    ...
    Private Function AddModification(ByVal objModificationDefinition As clsModificationDefinition, ByVal blnUseNextAvailableModificationSymbol As Boolean) As Integer
        ...
        '
        ' Returns the index of the newly added modification or the index of the modification that objModificationDefinition matches 
        ...
        If Not blnMatchFound Then
            If mModificationCount >= mModifications.Length Then
                ReDim Preserve mModifications(mModifications.Length * 2 - 1)
            End If
            ...
            mModifications(mModificationCount) = objModificationDefinition
            mModificationCount += 1
            Return mModificationCount - 1
        Else
    ...
    Public Function GetModificationByIndex(ByVal intIndex As Integer) As clsModificationDefinition
        If intIndex >= 0 And intIndex < mModificationCount Then
    ...
    Private Sub InitializeLocalVariables()
        ...
        ' Note: We initially reserve space for 10 modifications in mModifications
        ' This array will be expanded if needed, but is never shrunk
        ' Use mModificationCount to determine the number of modifications present in mModifications
        mModificationCount = 0
        ReDim mModifications(9)
    ...
    Public Function ReadMassCorrectionTagsFile(ByVal strFilePath As String, ByRef blnFileNotFound As Boolean) As Boolean
        Dim srMassCorrectionTagsFile As System.IO.StreamReader
        ...
        Try
            ...
            ElseIf Not System.IO.File.Exists(strFilePath) Then
                ...
                blnSuccess = False
            Else
                srMassCorrectionTagsFile = New System.IO.StreamReader(strFilePath)
        ...
        Catch ex As Exception
            ...
            blnSuccess = False
        Finally
            If Not srMassCorrectionTagsFile Is Nothing Then
                srMassCorrectionTagsFile.Close()
            End If
        End Try
    ...
    Public Function ReadModificationDefinitionsFile(ByVal strFilePath As String, ByRef blnFileNotFound As Boolean) As Boolean
        ...
        Dim srModificationFile As System.IO.StreamReader
        ...
        Try
            ...
            ElseIf Not System.IO.File.Exists(strFilePath) Then
                ...
                blnSuccess = False
            Else
                srModificationFile = New System.IO.StreamReader(strFilePath)
        ...
        Catch ex As Exception
            ...
            blnSuccess = False
        Finally
            If Not srModificationFile Is Nothing Then
                srModificationFile.Close()
            End If
        End Try
