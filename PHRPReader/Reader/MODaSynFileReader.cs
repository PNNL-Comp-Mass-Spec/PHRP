...
namespace PHRPReader.Reader
{
    ...
    public class MODaSynFileReader : SynFileReaderBaseClass
    {
        ...
        {
            return new SortedDictionary<string, MODaSynFileColumns>(StringComparer.OrdinalIgnoreCase)
            {
        ...
        /// </summary>
        /// <param name="searchEngineParamFileName">MODa parameter file name</param>
        /// <param name="searchEngineParams">Search engine parameters</param>
