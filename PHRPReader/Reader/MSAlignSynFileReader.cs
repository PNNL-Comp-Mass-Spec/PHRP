...
namespace PHRPReader.Reader
{
    ...
    public class MSAlignSynFileReader : SynFileReaderBaseClass
    {
        ...
        {
            return new SortedDictionary<string, MSAlignSynFileColumns>(StringComparer.OrdinalIgnoreCase)
            {
        ...
        /// </summary>
        /// <param name="searchEngineParamFileName">MSAlign parameter file name</param>
        /// <param name="searchEngineParams">Search engine parameters</param>
