...
namespace PHRPReader.Reader
{
    ...
    public class InspectSynFileReader : SynFileReaderBaseClass
    {
        ...
        {
            return new SortedDictionary<string, InspectSynFileColumns>(StringComparer.OrdinalIgnoreCase)
            {
        ...
        /// </summary>
        /// <param name="searchEngineParamFileName">InSpecT parameter file name</param>
        /// <param name="searchEngineParams">Search engine parameters</param>
