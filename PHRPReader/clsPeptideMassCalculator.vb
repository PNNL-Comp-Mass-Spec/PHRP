...
#End Region
    ...
    Private Sub AddAminoAcidStatEntry(intIndex As Integer, dblMonoisotopicMass As Double, CountC As Integer, CountH As Integer, CountN As Integer, CountO As Integer, CountS As Integer)
