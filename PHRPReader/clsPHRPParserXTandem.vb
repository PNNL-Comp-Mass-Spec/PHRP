...
#End Region
    ...
    Private Shared Function GetFastaFileFromTaxonomyFile(strInputFolderPath As String, strTaxononomyFilename As String, <Out()> ByRef strErrorMessage As String) As String
        ...
        Try
            ...
            Else
                ...
                Using objXMLReader As Xml.XmlTextReader = New Xml.XmlTextReader(strTaxonomyFilePath)
    ...
    Private Shared Function GetXTandemDefaultParamsFilename(strParamFilePath As String) As String
        ...
        Using objXMLReader As Xml.XmlTextReader = New Xml.XmlTextReader(strParamFilePath)
        ...
        Try
            ...
            With objPSM
                ...
                Else
                    ...
                    .PrecursorNeutralMass = mPeptideMassCalculator.ConvoluteMass(dblPeptideMH, 1, 0)
                    ...
                    If Double.TryParse(.MassErrorDa, dblMassErrorDa) Then
                        ...
                        .PrecursorNeutralMass = mPeptideMassCalculator.ConvoluteMass(dblPeptideMH - dblMassErrorDa, 1, 0)
                    End If
