...
#End Region
    ...
    Private Sub InitializeRegExObjects()
        ...
        Try
            ...
            If mEnzymeMatchSpec.LeftResidueRegEx = TRYPSIN_LEFT_RESIDUE_REGEX AndAlso
               mEnzymeMatchSpec.RightResidueRegEx = TRYPSIN_RIGHT_RESIDUE_REGEX Then
