Module modMain
	...
	Public Sub Main()
        ...
        Const strMSGFPlusFolder As String = "\\proto-7\VOrbiETD03\2015_1\proteogeomics_32_crude_heavy_peptides_200f_25Feb15_Tiger_15-01-26\MSG201503091410_Auto1169297"
    ...
    Private Sub TestPHRPReader(ByVal strSynOrFHTFile As String, ByVal blnSkipDuplicates As Boolean)
        ...
        Do While mPHRPReader.MoveNext()
            ...
            Dim primarySequence As String = String.Empty
            Dim prefix As String = String.Empty
            Dim suffix As String = String.Empty
            PHRPReader.clsPeptideCleavageStateCalculator.SplitPrefixAndSuffixFromSequence(oPsm.Peptide, primarySequence, prefix, suffix)
    ...
    Private Function CleanupPeptide(ByVal strPeptide As String) As String
        ...
        Static reFindItraq As Text.RegularExpressions.Regex = New Text.RegularExpressions.Regex("^([A-Z][^A-Z]*)(\+144\.\d+)(.+)", Text.RegularExpressions.RegexOptions.Compiled Or Text.RegularExpressions.RegexOptions.IgnoreCase)
    ...
    Private Function FlattenList(ByVal lstValues As List(Of String), ByVal chSepChar As Char) As String
        Dim sbOutline As Text.StringBuilder = New Text.StringBuilder()
